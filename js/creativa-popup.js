class CreativaPopup {
  ...
  static create(text, title, icon, inputOptions) {
    ...
    divBox.innerHTML =
      ...
      popupId +
      `"></p>
                <div class="ct-popup-other-content" id="ct-popup-other-content-` +
      popupId +
      `"></div>
            </div>
    ...
    let popupCloseIcon = document.getElementById(
      "ct-popup-close-icon-" + popupId
    );
    let popupOtherContent = document.getElementById(
    ...
    // Other box style
    if (options.width)
      popupBoxStyle += " width: " + options.width + " !important;";
    if (options.height)
      popupBoxStyle += " height: " + options.height + " !important;";
