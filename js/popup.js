...
function popup13() {
  CreativaPopup.create(
    'Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">kirbo</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://discord.gg/juJbqUmU9N" style="color: #ADD8E6;">https://discord.gg/juJbqUmU9N</a> </font>',
    "Discord",
    "",
    {
      titleColor: "#6ffcff",
...
function allahm109kd() {
  navigator.clipboard.writeText("kirbo");
  setTimeout(function () {
